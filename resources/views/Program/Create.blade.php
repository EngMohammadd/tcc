...
@section('content')
    <div class="mb-4">
        ...
        <form method="POST" action="{{ route('Program.store') }}" enctype="multipart/form-data">
            ...
            <div class="mb-3">
                <label for="exampleFormControlInput1" class="form-label">{{__('views/post.title').' '.__('views/post.program')}}</label>
                <input type="text" name="title" cols="30" rows="8" placeholder="{{__('views/post.title').' '.__('views/post.program')}}" class="form-control">
                @error('title')
            ...
            {{-- <div class="mb-3">
                <label for="exampleFormControlInput1" class="form-label">{{__('views/post.description').' '.__('views/post.program')}}</label>
                <textarea name="description" cols="30" rows="8" placeholder="{{__('views/post.description').' '.__('views/post.program')}}" class="form-control"></textarea>
            </div>
